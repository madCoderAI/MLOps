...
Xtrain_path = "hf://datasets/yuRIrocks/Tourism-Package-Prediction/Xtrain.csv"
Xtest_path = "hf://datasets/yuRIrocks/Tourism-Package-Prediction/Xtest.csv"
ytrain_path = "hf://datasets/yuRIrocks/Tourism-Package-Prediction/ytrain.csv"
ytest_path = "hf://datasets/yuRIrocks/Tourism-Package-Prediction/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_xgboost_model_v1.joblib"
    ...
    repo_id = "yuRIrocks/Tourism-Package-Prediction"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_xgboost_model_v1.joblib",
        path_in_repo="best_xgboost_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
